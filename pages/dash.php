...
<body style="background: linear-gradient(to bottom right, #00ccff 0%, #ccffff 100%);}">
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted">44% Complete</span>
                                    </p>
								...
								<div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted">75% Complete</span>
                                    </p>
                                    <div class="progress progress-striped active">
    ...
    <!-- /#wrapper -->
	 <div id="page-wrapper" >
            <div class="row">
                <div class="col-lg-12">
                   <h4 class="page-header"><b> <?php echo strtoupper("welcome"." ".htmlentities($_SESSION['login']));?></b></h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			  <div class="container-fluid">
					  <div class="row">
						<div class="col-sm-4 card" >
						  <div class="jumbotron jumbotron-fluid" style="background: linear-gradient(to top left, #33ccff 37%, #3366ff 100%);box-shadow: 0 8px 12px 0 rgba(0,0,0,0.2);border-radius:20px;">
								  <div class="container" >
						  ...
						  <div class="col-sm-4">
							<img src="images\f2.jpg" alt="Norway" style="width:100%;padding-top:20px">
						</div>
						
					
						<div class="col-sm-offset-8">
							<img src="images\f1.jpg" alt="Norway" style="width:50%">
						</div>
						
						</div>
					<div class="row">
					  <div class="col-sm-6" style="border-radius:40px ;">
					<img src="images\f3.png" alt="Norway" style="width:100%;border-radius:40px  ">
					</div>
					<div class="col-sm-2"></div>
					
					<div class="col-sm-4" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);padding:20px">
							<div class="card" style="width:100%">
							  <img class="card-img-top" src="images\f4.png" alt="Card image" style="width:100%;border-radius:50px">
							  <div class="card-body" style="color:#212121">
								<h4 class="card-title">PROJECT MANAGMENT STATUS</h4>
								<p class="card-text">-Repoter to be complete on time</p>
							  </div>
							</div>
